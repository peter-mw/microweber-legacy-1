...
<div class="mw-ui-label"><?php print $data["custom_field_name"]; ?></div>
  ...
  <label class="mw-ui-check">
    <input type="radio" <?php if($is_required and $i==1){ ?> required <?php } ?> name="<?php print $data["custom_field_name"]; ?>"    data-custom-field-id="<?php print $data["id"]; ?>" value="<?php print $kv; ?>" <?php if(isset($data['value']) == true and $data['value'] == $kv): ?> checked="checked" <?php endif; ?> />
    <span></span>
